...
class AtGoal extends Blueshell.Action<any, any> {
	constructor() {
		super('at-goal');
	}
...
class AtWall extends Blueshell.Action<any, any> {
	constructor() {
		super('at-goal');
	}
...
class Move extends Blueshell.Action<any, any> {
	constructor() {
		super('move');
	}
...
export class Behavior extends Blueshell.LatchedSelector<any, any> {
	constructor() {
		super('robot-ai', [
			new AtGoal(),
			new AtWall(),
